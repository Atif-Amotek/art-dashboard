            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-900">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link href="/" className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700">
                                <IconHome2 />
                                <span className="ml-3">Home</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/members" className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700">
                                <IconUsers />
